...
Fields defined in an --include argument will always be included in the output.
...
Fields defined in an --exclude argument will be excluded from the output.
...
Fields defined in an --only argument will be the only fields in the output.
